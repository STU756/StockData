...
public class StockDataService {
	...
	private void spiderStockData(StockData stockData, String stockDirectory) {
	...
	public static void main(String[] args) throws IOException {
		...
		StockData stockData = parseData2StockData(dataStr);
	 ...
	 * 0：豆粕连续，名字
		...
		16：豆粕，品种名简称
		17：2013-06-28，日期
		var hq_str_M1805="豆粕1805,221710,3087,3091,3043,3097,3048,3049,3049,3062,3115,371,400,1753900,659738,连,豆粕,2018-03-09,1,3158.000,3078.000,3159.000,2959.000,3159.000,2757.000,3159.000,2720.000,37.641";
	 * @param dataStr
	 * @return StockData
	 */
